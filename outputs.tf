...
output "single_cluster_account" {
  value = "${var.single_cluster_account == true ? "Single cluster account" :
"Multi cluster account"}"
}

output "create_worker_cluster" {
  value = "${var.create_worker_cluster == true ? "Worker cluster created" :
"Worker cluster not created"}"
}
...
output "kafka_launch_configuration_id" {
  value = "${element(concat(aws_launch_configuration.ecs_kafka.*.id, list("")), 0)}"
}

output "kafka_launch_configuration_name" {
  value = "${element(concat(aws_launch_configuration.ecs_kafka.*.name, list("")), 0)}"
}
...
output "kafka_aws_autoscaling_group_id" {
  value = "${element(concat(aws_autoscaling_group.ecs_kafka.*.id, list("")), 0)}"
}

output "kafka_aws_autoscaling_group_arn" {
  value = "${element(concat(aws_autoscaling_group.ecs_kafka.*.arn, list("")), 0)}"
}

output "kafka_aws_autoscaling_group_min_size" {
  value = "${element(concat(aws_autoscaling_group.ecs_kafka.*.min_size, list("")), 0)}"
}

output "kafka_aws_autoscaling_group_max_size" {
  value = "${element(concat(aws_autoscaling_group.ecs_kafka.*.max_size, list("")), 0)}"
}

output "kafka_aws_autoscaling_group_default_cooldown" {
  value = "${element(concat(aws_autoscaling_group.ecs_kafka.*.default_cooldown, list("")), 0)}"
}

output "kafka_aws_autoscaling_group_name" {
  value = "${element(concat(aws_autoscaling_group.ecs_kafka.*.name, list("")), 0)}"
}

output "kakfa_aws_autoscaling_group_health_check_grace_period" {
  value = "${element(concat(aws_autoscaling_group.ecs_kafka.*.health_check_grace_period, list("")), 0)}"
}

output "kakfa_aws_autoscaling_group_health_check_type" {
  value = "${element(concat(aws_autoscaling_group.ecs_kafka.*.health_check_type, list("")), 0)}"
}

output "kafka_aws_autoscaling_group_desired_capacity" {
  value = "${element(concat(aws_autoscaling_group.ecs_kafka.*.desired_capacity, list("")), 0)}"
}

output "kafka_aws_autoscaling_group_launch_configuration" {
  value = "${element(concat(aws_autoscaling_group.ecs_kafka.*.launch_configuration, list("")), 0)}"
}
...
output "aws_ecs_efs_file_system_id" {
  value = "${element(concat(aws_efs_file_system.ecs_volumes.*.id, list("")), 0)}"
}
